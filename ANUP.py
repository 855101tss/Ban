...
TOKEN = '7681539984:AAEkdLhdkB_xgighe_WKsHXx9r4HAX-z0Gc'  # Replace with your actual bot token
...
def bgmi_command(message):
    ...
    try:
        ...
        logging.info(f"Attack started by {user_name}: ./bgmi {target_ip} {target_port} {default_duration} 180")
